...
public interface State {
    public default boolean loadMap(ListOfCommands l, Controller c){return false;}; // initialState
    public default boolean loadRequests(ListOfCommands l, Controller c){return false;}; // MapLoadedState
